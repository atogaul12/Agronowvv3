...
class Main extends db{
	...
	function Run(){
		...
		if($baseDir=="be") {
			...
			$navToShow = ($this->pageBase=="be")? 'home' : $this->pageBase;
		...
		if(file_exists($dcontroller)){
			...
			if($baseDir=="fe") {
				echo '<br/><br/><a href="'.FE_MAIN_HOST.'">klik disini untuk menuju halaman depan</a>';
			} else {
				echo '<br/><br/><a href="'.BE_MAIN_HOST.'">klik disini untuk menuju halaman depan (BE)</a>';
			}
		}
	}
}
