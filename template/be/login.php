                  ...
                  <div class="card rounded-4 mb-0 border-top border-4 border-primary ">
                     <div class="card-body p-5">
                        ...
                        <div class="form-body my-3">
                           <form class="row g-3" action="<?=BE_MAIN_HOST?>/user/do_login" method="post">
                              <div class="col-12">
                              ...
                              <div class="col-12">
                                 ...
                                 <div class="input-group" id="show_hide_password">
                                    <input type="password" class="form-control border-end-0" id="password" name="password" value="" placeholder="password"> 
                        ...
                        <div class="separator section-padding">
                           <div class="line"></div>
                           <p class="mb-0 fw-bold">butuh bantuan?</p>
                           <div class="line"></div>
                        </div>
                        <p class="mb-0 mt-4"><a href="<?=BE_MAIN_HOST?>/user/panduan" class="fw-bold">Baca Panduan</a></p>
                     </div>
                  </div>
               </div>
            </div>
