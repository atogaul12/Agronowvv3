<?php
//frameworkv2/template/be/ikhtisar-nilai/peserta.php
?>
        ...
        <div class="card-body">
            <form method="post" action="<?= $targetpage ?>" id="filterForm">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?= BE_MAIN_HOST ?>/ikhtisar-nilai/peserta?reset=1" class="btn btn-secondary" style="width: 120px;">
        ...
        <div class="tab-pane fade" id="excel" role="tabpanel">
            <div class="card stretch stretch-full" style="border-top-left-radius:0">
                ...
                <div class="card-body">
                    ...
                    <a href="<?= BE_MAIN_HOST ?>/ikhtisar-nilai/peserta?export=excel" class="btn btn-primary btn-block w-100">
                        <i class="feather-download me-2"></i>Download Excel
                    </a>
                </div>
            </div>
...
<script>
    ...
    inputPelatihan.addEventListener('keyup', function() {
        ...
        timer = setTimeout(() => {
            fetch('<?= BE_MAIN_HOST ?>/ikhtisar-nilai/peserta?ajax=pelatihan&q=' + encodeURIComponent(keyword))
                .then(res => res.json())
                .then(data => {
