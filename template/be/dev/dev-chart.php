					...
					<div class="d-flex flex-column justify-content-between gap-4">
						<div class="d-flex align-items-center gap-4">
							<div class="d-flex align-items-center gap-3 flex-grow-1">
								<img src="<?=BE_ASET_HOST?>/assets/images/avatar.png" width="32" alt="">
			...
			<div class="card w-100 rounded-4">
				...
				<div class="card-body p-0">
					<div class="user-list p-3">
						<div class="d-flex flex-column gap-3">
							<div class="d-flex align-items-center gap-3">
								<img src="<?=BE_ASET_HOST?>/assets/images/avatar.png" width="45" height="45" class="rounded-circle" alt="">
								<div class="flex-grow-1">
							...
							<tbody>
								<tr>
									<td>
										<div class="d-flex align-items-center gap-3">
											<div class="">
												<img src="<?=BE_ASET_HOST?>/assets/images/avatar.png" class="rounded-circle" width="50" height="50" alt="">
											</div>
